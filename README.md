...
```bash
docker build -t parquet_checker . && docker run --rm -v $(pwd):/app -w /app parquet_checker
```
...
```
##########################################################################################
Analysis of parquet files created by polars:
##########################################################################################
No errors found
shape: (2, 2)
┌────────────────┬──────────────────┐
│ name_test      ┆ total_violations │
│ ---            ┆ ---              │
│ str            ┆ u32              │
╞════════════════╪══════════════════╡
│ polars_pyarrow ┆ 78               │
...
│ str         ┆ f64         ┆ f64         ┆ f64      ┆ f64               │
╞═════════════╪═════════════╪═════════════╪══════════╪═══════════════════╡
│ polars_rust ┆ 1.5194e-293 ┆ 9.703731    ┆ 9.703731 ┆ 6.3867e293        │
│ polars_rust ┆ 9.703731    ┆ 1.5194e-293 ┆ 9.703731 ┆ 1.0               │
│ polars_rust ┆ 1.4252e-293 ┆ -9.102003   ┆ 9.102003 ┆ 6.3867e293        │
│ polars_rust ┆ -9.102003   ┆ 1.4252e-293 ┆ 9.102003 ┆ 1.0               │
│ polars_rust ┆ 1.4209e-293 ┆ -9.074918   ┆ 9.074918 ┆ 6.3867e293        │
└─────────────┴─────────────┴─────────────┴──────────┴───────────────────┘
sorted by abs_relative_diff
head
shape: (5, 5)
┌─────────────┬─────────────┬─────────────┬──────────┬───────────────────┐
│ name_test   ┆ data_1      ┆ data_2      ┆ abs_diff ┆ abs_relative_diff │
...
│ polars_rust ┆ 1.4252e-293 ┆ -9.102003   ┆ 9.102003 ┆ 6.3867e293        │
│ polars_rust ┆ 1.4209e-293 ┆ -9.074918   ┆ 9.074918 ┆ 6.3867e293        │
│ polars_rust ┆ 7.8709e-294 ┆ 5.026868    ┆ 5.026868 ┆ 6.3867e293        │
│ polars_rust ┆ 9.703731    ┆ 1.5194e-293 ┆ 9.703731 ┆ 1.0               │
└─────────────┴─────────────┴─────────────┴──────────┴───────────────────┘
sorted by abs_diff
head
...
│ str            ┆ f64         ┆ f64         ┆ f64      ┆ f64               │
╞════════════════╪═════════════╪═════════════╪══════════╪═══════════════════╡
│ polars_pyarrow ┆ 7.2492e-294 ┆ 4.629864    ┆ 4.629864 ┆ 6.3867e293        │
│ polars_pyarrow ┆ 4.629864    ┆ 7.2492e-294 ┆ 4.629864 ┆ 1.0               │
│ polars_pyarrow ┆ -2.915768   ┆ -6.581535   ┆ 3.665768 ┆ 1.257222          │
│ polars_pyarrow ┆ -6.581535   ┆ -2.915768   ┆ 3.665768 ┆ 0.556978          │
│ polars_pyarrow ┆ -2.965888   ┆ -5.681776   ┆ 2.715888 ┆ 0.915708          │
└────────────────┴─────────────┴─────────────┴──────────┴───────────────────┘
sorted by abs_relative_diff
head
shape: (5, 5)
...
╞════════════════╪═════════════╪═════════════╪══════════╪═══════════════════╡
│ polars_pyarrow ┆ 7.2492e-294 ┆ 4.629864    ┆ 4.629864 ┆ 6.3867e293        │
│ polars_pyarrow ┆ 0.000047    ┆ 0.003229    ┆ 0.003182 ┆ 68.234917         │
│ polars_pyarrow ┆ -2.915768   ┆ -6.581535   ┆ 3.665768 ┆ 1.257222          │
│ polars_pyarrow ┆ 4.629864    ┆ 7.2492e-294 ┆ 4.629864 ┆ 1.0               │
│ polars_pyarrow ┆ 0.003229    ┆ 0.000047    ┆ 0.003182 ┆ 0.985556          │
└────────────────┴─────────────┴─────────────┴──────────┴───────────────────┘
##########################################################################################
Analysis of parquet files created by pandas:
##########################################################################################
No errors found
No violations found
```